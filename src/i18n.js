export const TRANSLATIONS = {
  en: {
    ...
    grade2: 'Grade 2 contractions (EN)',
    grade2Hint: 'Applies UEB contractions: "the" → ⠮, "and" → ⠯, "ing" → ⠬ …',
  ...
  ru: {
    ...
    grade2: 'Сокращения Grade 2 (EN)',
    grade2Hint: 'Применяет сокращения UEB: "the" → ⠮, "and" → ⠯, "ing" → ⠬ …',
